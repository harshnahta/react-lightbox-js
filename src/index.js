...
const LoadModal = ({
  ...
  const [data, setData] = useState({
    zoomIndex: 0,
    sliderIndex: sliderIndex,
    enlargeScreen: defaultFullScreen,
    xCursor: 0,
    yCursor: 0,
    xImgEle: 0,
    yImgEle: 0
  ...
  const listenerStart = () => {
    document.getElementById('drag-img').addEventListener('mousedown', startDrag)
    document.getElementById('drag-img').addEventListener('mousemove', whileDrag)
    document.getElementById('drag-img').addEventListener('mouseup', stopDrag)
    document.getElementById('drag-img').addEventListener('mouseleave', stopDrag)
  }
  const removeListner = () => {
    document
